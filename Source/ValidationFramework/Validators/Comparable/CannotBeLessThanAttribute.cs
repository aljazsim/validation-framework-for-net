...
namespace ValidationFramework
{
    ...
    public sealed class CannotBeLessThanAttribute : ValidationAttribute
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CannotBeLessThanAttribute"/> class.
        /// </summary>
        /// <param name="minValue">The minimum value.</param>
        public CannotBeLessThanAttribute(int minValue)
            : this()
        {
        ...
        /// </summary>
        /// <param name="minValue">The minimum value.</param>
        public CannotBeLessThanAttribute(ushort minValue)
            : this()
        {
            this.MinValue = minValue;
        }
        ...
        /// </summary>
        /// <param name="minValue">The minimum value.</param>
        public CannotBeLessThanAttribute(byte minValue)
            : this()
        {
            this.MinValue = minValue;
        }
        ...
        /// </summary>
        /// <param name="minValue">The minimum value.</param>
        public CannotBeLessThanAttribute(short minValue)
            : this()
        {
            this.MinValue = minValue;
        }
        ...
        /// </summary>
        /// <param name="minValue">The minimum value.</param>
        public CannotBeLessThanAttribute(sbyte minValue)
        : this()
        {
            this.MinValue = minValue;
        }
        ...
        /// </summary>
        /// <param name="minValue">The minimum value.</param>
        public CannotBeLessThanAttribute(long minValue)
            : this()
        {
            this.MinValue = minValue;
        }
        ...
        /// </summary>
        /// <param name="minValue">The minimum value.</param>
        public CannotBeLessThanAttribute(uint minValue)
            : this()
        {
            this.MinValue = minValue;
        }
        ...
        /// </summary>
        /// <param name="minValue">The minimum value.</param>
        public CannotBeLessThanAttribute(ulong minValue)
            : this()
        {
            this.MinValue = minValue;
        }
        ...
        /// </summary>
        /// <param name="minValue">The minimum value.</param>
        public CannotBeLessThanAttribute(decimal minValue)
            : this()
        {
            this.MinValue = minValue;
        }
        ...
        /// </summary>
        /// <param name="minValue">The minimum value.</param>
        public CannotBeLessThanAttribute(float minValue)
            : this()
        {
            this.MinValue = minValue;
        }
        ...
        /// </summary>
        /// <param name="minValue">The minimum value.</param>
        public CannotBeLessThanAttribute(double minValue)
            : this()
        {
            this.MinValue = minValue;
        }
        ...
        /// </summary>
        /// <param name="minValue">The minimum value.</param>
        public CannotBeLessThanAttribute(IComparable minValue)
            : this()
        {
        ...
        /// <summary>
        /// Prevents a default instance of the <see cref="CannotBeLessThanAttribute"/> class from being created.
        /// </summary>
